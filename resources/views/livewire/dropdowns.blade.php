<div>
    ...
    {{-- @if (!is_null($selectedProvinsi)) --}}
        <div class="form-group">
            ...
            <select wire:model="selectedKota" class="form-control" name="kota" required>
    ...
    {{-- @if (!is_null($selectedKota)) --}}
        <div class="form-group">
            ...
            <select wire:model="selectedKecamatan" class="form-control" name="kota" required>
    ...
    {{-- @if (!is_null($selectedKecamatan)) --}}
        <div class="form-group">
            ...
            <select wire:model="selectedKelurahan" class="form-control" name="kota" required>
    ...
    {{-- @if (!is_null($selectedKelurahan)) --}}
        <div class="form-group">
            ...
            <select class="form-control" wire:model="selectedRw" name="id_rw" required>
